...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY'				=> 'Calitatea imaginilor atașate (doar JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Specificați o valoare între 50% (dimensiune mai mică a fișierului) și 90% (calitate mai înaltă). O calitate mai mare de 90% crește dimensiunea fișierului și este dezactivată. Această setare se aplică doar dacă dimensiunile maxime ale imaginii sunt setate la o valoare diferită de 0px pe 0px.',
	'IMAGE_STRIP_METADATA'		=> 'Elimină metadatele imaginii (doar JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Elimină metadatele Exif, de exemplu, numele autorului, coordonatele GPS și detaliile camerei. Această setare se aplică doar dacă dimensiunile maxime ale imaginii sunt setate la o valoare diferită de 0px pe 0px.',
	...
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Nu există <a href="%s">grupuri de extensii permise</a> pentru mesajele private.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Nu există <a href="%s">grupuri de extensii permise</a> pentru mesaje.',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'Fișierul “%1$s” nu poate fi încărcat la mesajul cu numărul %2$d deoarece mesajul nu există.',
));
