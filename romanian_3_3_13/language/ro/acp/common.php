...
$lang = array_merge($lang, array(
	...
	'CONTAINER_EXCEPTION' => 'phpBB a întâmpinat o eroare la construirea containerului din cauza unei extensii instalate. Din acest motiv, toate extensiile au fost dezactivate temporar. Vă rugăm să încercați să ștergeți cache-ul forumului. Toate extensiile vor fi reactivare automat odată ce eroarea containerului este rezolvată. Dacă această eroare persistă, vă rugăm să vizitați <a href="https://www.phpbb.com/support">phpBB.com</a> pentru suport.',
	'EXCEPTION' => 'Excepție',
	...
	'CSV_INVALID'			=> 'Setarea separată prin virgule furnizată „%1$s” este invalidă. Valorile ar trebui să fie delimitate doar prin virgulă și nu ar trebui să conțină delimitatori la început sau la sfârșit.',
	...
	'RELEASE_ANNOUNCEMENT'		=> 'Anunț',
	'REMIND'							=> 'Reaminteşte',
	'REPARSE_LOCK_ERROR'				=> 'Reanalizarea este deja în desfășurare de către un alt proces.',
	...
	'URL_INVALID'			=> 'URL-ul furnizat pentru setarea „%1$s” este invalid.',
	'URL_SCHEME_INVALID'	=> 'Schema furnizată „%2$s” în setarea separată prin virgule „%1$s” este invalidă. Schema ar trebui să înceapă cu un caracter latin urmat de caractere alfanumerice, liniuțe sau puncte.',
	'USERNAMES_EXPLAIN'		=> 'Introduceţi fiecare nume de utilizator pe linii separate.',
	'USER_CONTROL_PANEL'	=> 'Panoul utilizatorului',

	'UPDATE_NEEDED'			=> 'Forumul nu este actualizat.',
	'UPDATE_NOT_NEEDED'		=> 'Forumul este actualizat.',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var> trebuie să fie gol. Puteți verifica valoarea curentă în secțiunea <samp>PHP information</samp>.',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'Caracterul de conversie ieșire HTTP este configurat necorespunzător',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var> trebuie să fie gol. Puteți verifica valoarea curentă în secțiunea <samp>PHP information</samp>.',
	'ERROR_DEFAULT_CHARSET'							=> 'Setarea implicită a setului de caractere este configurată incorect.',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var> trebuie setat la <samp>UTF-8</samp>. Puteți verifica valoarea curentă în secțiunea <samp>PHP information</samp>.',
	...
	'PHP_VERSION_OLD'	=> 'Versiunea de PHP de pe acest server (%1$s) nu va mai fi suportată de versiunile viitoare ale phpBB. Versiunea minimă necesară va fi PHP %2$s. %3$sDetalii%4$s',
	...
	'VERSION_CHECK'					=> 'Verifică versiunea',
	'VERSION_CHECK_EXPLAIN'			=> 'Verifică dacă instalarea ta phpBB este actualizată.',
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Informațiile despre ultima versiune conțin o intrare nesuportată.',
	'VERSIONCHECK_INVALID_URL'		=> 'Informațiile despre ultima versiune conțin un URL invalid.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Informațiile despre ultima versiune conțin o versiune invalidă.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Instalarea dumneavoastră phpBB nu este actualizată.<br />Mai jos găsiți o legătură către anunțul de lansare, ce conține mai multe informații, precum și instrucțiuni pentru actualizare.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Instalarea dumneavoastră phpBB nu este actualizată.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Instalarea dumneavoastră phpBB este actualizată. Nu sunt actualizări disponibile momentan.',
...
$lang = array_merge($lang, array(
	...
	'SEND_STATISTICS'			=> 'Trimite statistici',
	'SEND_STATISTICS_LONG'		=> 'Trimite informaţii statistice',
	'SHOW_STATISTICS'			=> 'Arată detaliile',
	'THANKS_SEND_STATISTICS'	=> 'Vă mulţumim că aţi trimis informaţiile proprii.',
	'FAIL_SEND_STATISTICS'		=> 'phpBB nu a putut trimite statisticile',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Utilizatorii cu accesele de forum adăugate sau modificate</strong> în %1$s<br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Utilizatorii cu accesele de moderator de forum adăugate sau modificate</strong> în %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Grupurile cu accesele de forum adăugate sau modificate</strong> în %1$s<br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Grupurile cu accesele de moderator de forum adăugate sau modificate</strong> în %1$s<br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Moderatori adăugaţi sau modificaţi</strong> în %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Permisiunile forumului adăugate sau modificate</strong> în %1$s<br />» %2$s',
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>Eroare la configurarea codului BB</strong>: %1$s<br />» %2$s',
	...
	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus nu permite interogările utilizând un resolver deschis. Verificarea listei negre a fost dezactivată. Pentru mai multe informații, consultați https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Limita de volume de interogări Spamhaus a fost depășită. Verificarea listei negre a fost dezactivată. Pentru mai multe informații, consultați https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	...
	'LOG_EXT_UPDATE'	=> '<strong>Extensie actualizată</strong><br />» %s',
));
