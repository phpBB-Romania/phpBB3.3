...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Pentru informaţii suplimentare legate de configurarea şi administrarea permisiunilor forumului phpBB3, vă rugăm să vizitaţi secțiunea <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Setarea permisiuniilor din Ghidul rapid</a>.</p>
	',

	'ACL_NEVER'				=> 'Niciodată',
	'ACL_SET'				=> 'Configurare permisiuni',
	'ACL_SET_EXPLAIN'		=> 'Permisiunile sunt bazate pe un simplu sistem <samp>DA</samp>/<samp>NU</samp>. Opţiunea <samp>NICODATĂ</samp> specificată pentru un utilizator sau grup utilizatori înlocuieşte orice altă valoare atribuită. Dacă nu doriţi să atribuiţi o valoare pentru o opţiune acestui utilizator sau grup selectaţi <samp>NU</samp>. Dacă valorile sunt atribuite pentru această opţiune, ele vor fi folosite în preferinţe, altfel <samp>NICIODATĂ</samp> este asumat. Toate obiectele marcate (cu o căsuţă de marcaj în faţa lor) vor copia permisiunile pe care le-aţi definit. Vă rugăm să rețineți că setarea permisiunilor administrative pentru conturile de fondator nu are niciun efect, deoarece permisiunile de admin sunt întotdeauna setate la <strong>DA</strong> pentru fondatori.',
